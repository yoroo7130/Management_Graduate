...
namespace A_오징어_EduMgr
{
    class OraMember
    {
        ...
        // 회원 정보
        public int InsertMemberInfo(params string[] values)
        {
            string query = "INSERT INTO t_userinfo VALUES(USERINFO_SEQ.NEXTVAL, :param0, :param1, :param2, :param3, :param4, :param5)";
            count = conn.ExecQuery(query, values);
        ...
        // 회원 로그인
        public int InsertMemberLogin(params string[] values)
        {
            string query = "INSERT INTO t_login VALUES(LOGIN_SEQ.NEXTVAL, :param0, :param1)";
            count = conn.ExecQuery(query, values);
